...
[_LAYER0] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, LT(3,KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, LT(4,KC_ENT), KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_SPC, KC_SPC, LT(2,KC_ENT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
...
[_LAYER4] = LAYOUT(RGB_TOG, DYN_REC_START1, DYN_REC_START2, KC_TRNS, KC_TRNS, KC_TRNS, KC_WH_D, KC_BTN1, KC_MS_U, KC_BTN2, KC_NO, LCTL(LSFT(LGUI(KC_4))), KC_NO, DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, KC_NO, KC_NO, KC_NO, KC_WH_U, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_WH_R, KC_WH_L, KC_NO, KC_NO, KC_NO, KC_TRNS, MU_ON, MU_OFF, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_SPD, RESET, DEBUG, RGB_SPI) 
